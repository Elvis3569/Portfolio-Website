    ...
    <section className="about" id="about">
      <div className="about__details">
        ...
        <p className="about__text">
          Hello! My name is Elvis and I am passionate about web applications. I
          ...
          have some experience with some backend technologies like Java,
          SpringFramework,Postgres, Mysql.
        </p>
        <p className="about__text">
